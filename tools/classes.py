"""
Classes for ImageNet 2012 and Stanford Dogs dataset.

# Description: This file contains the classes for the dataset and the model.

References:
Lhoest, Q. (2022) 'classes.py · ILSVRC/imagenet-1k at main'. HuggingFace. Available at: https://huggingface.co/datasets/ILSVRC/imagenet-1k/blob/main/classes.py (Accessed: 10 March 2024).
